...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let jarFile = fs_1.default.readFileSync(pluginJarPath);
            const sha256Hash = crypto_1.default.createHash('sha256').update(jarFile).digest('hex');
            const fileSizeInBytes = fs_1.default.statSync(pluginJarPath).size;
            const pluginJson = {
            ...
            fs_1.default.writeFileSync(pluginJsonPath, pluginsData, 'utf8');
        }
        catch (error) {
